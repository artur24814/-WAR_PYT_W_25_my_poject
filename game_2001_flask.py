...
<p>komputer choose : {x1}</p>
<p>komputer choose : {x2}</p>
...
def geme():
    if request.method == 'POST':
        ...
        return GEME_HTML.format(gemer_point=gemer_point, komputer_point=komputer_point, x1=x1, x2=x2, y=y, x=x, gemer_point_w=gemer_point, komputer_point_w=komputer_point)
    else:
        return GEME_HTML.format(gemer_point=0, komputer_point=0, x1=6, x2=6, gemer_point_w=0, komputer_point_w=0, y=0, x=0)
  #      return HELLO_HTML.format(0, 0, x1, x2)
